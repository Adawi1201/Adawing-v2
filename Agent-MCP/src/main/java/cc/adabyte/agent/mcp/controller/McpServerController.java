...
public class McpServerController {
    ...
    @PostMapping
    public ResponseEntity<?> handle(@RequestBody JsonRpcRequest req, HttpServletResponse response) {
    ...
    private ResponseEntity<?> handleToolsList(JsonRpcRequest req) {
    ...
    private ResponseEntity<?> handleToolsCall(JsonRpcRequest req) {
