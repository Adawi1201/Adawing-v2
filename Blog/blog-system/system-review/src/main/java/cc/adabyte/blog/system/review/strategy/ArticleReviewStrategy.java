...
public class ArticleReviewStrategy implements ReviewStrategy {
    ...
    public void onReject(Long contentId, String reason, String reviewerNote) {
        eventPublisher.publishEvent(new ContentRejectedEvent(contentId, "article", reason, reviewerNote));
    }
}
